...
//	saveDF2mongo().saveDF(aggreagteDFTemp, "aggregateCaData")
	...
	//全国，p6_t1_nationwide
	val titleList_p6_t1_nationwide = List("", "2018Q1", "2018Q2", "2018Q3", "2018Q4", "", "", "", "")
	val limitNum_p6_t1_nationwide = 9
	val valueTypeList_p6_t1_nationwide = List("sales", "share")
	val dataList_p6_t1_nationwide = List("2018Q1", "2018Q2", "2018Q3", "2018Q4")
	...
	val titleList_p8_t1_nationwide = List("", "2018Q4YTD", "")
	...
	val limitNum_p8_t2_nationwide = 13
