...
case class cityPPT() {
	def getCityList(cityName: String): List[pptInputData] ={
		...
		val p2_t1 = pptInputData("p2_t1_" + cityStr, dataList, valueTypeList, filterList, mergeList, poivtList, limitNum_p2_t1, sortMap,
			sortStr_nomal, selectList, titleList, factory_nomal, keyProdListNomal)
		...
		val limitNum_p3_t1 = 16
		val p3_t1 = pptInputData("p3_t1_" + cityStr, List("2018Q4YTD"), List("share", "growth", "sales"),
			filterList_p3_t1, mergeList, poivtList, limitNum_p3_t1, sortMap_p2_t1, sortStr_nomal, selectList,
			List(List("", "份额", "增长", "Size")), factory_nomal, keyProdListNomal)
		...
		val p4_t1 = pptInputData("p4_t1_" + cityStr, dataList_p3, valueTypeList, filterList_p3, mergeList, poivtList,
			limitNum_p4_t1, sortMap_p3_t1, sortStr_other, selectList, titleList_p2, factory_nomal, keyProdListNomal)
		...
		val keyProdList_P5 = List("格华止")
		val p5_t1 = pptInputData("p5_t1_" + cityStr, dataList, valueTypeList, filterList_p4_t1, mergeList, poivtList,
			limitNum_p5_t1, sortMap_p4_t1, sortStr_other, selectList, titleList, factory_nomal, keyProdList_P5)
		...
		val p5_t2 = pptInputData("p5_t2_" + cityStr, dataList_p4_t2, valueTypeList_p4_t2, filterList_p4_t2, mergeList,
			poivtList_p4_t2, limitNum_p5_t2, sortMap_p4_t2, sortStr_nomal, selectList_p4_t2, titleList_p4_t2, factory_rank,
			keyProdList_P5)
		...
		val p6_t1 = pptInputData("p6_t1_" + cityStr, dataList, valueTypeList_6_1, filterList_p5_1, mergeList, poivtList,
			limitNum_p6_t1, sortMap_p5_t1, sortStr_other, selectList, titleList_p5_t1, factory_nomal, keyProdList_p6)
		...
		val p6_t2 = pptInputData("p6_t2_" + cityStr, dataList_p5_t2, valueTypeList_p6_t2, filterList_p5_t2, mergeList,
			selectList_p5_t2, limitNum_p6_t2, sortMap_p6_t2, sortStr_nomal, selectList_p5_t2, titleList_p6_t2, factory_rank,
			keyProdList_p6)
		...
		val p7_t1 = pptInputData("p7_t1_" + cityStr, dataList_p6_t1, valueTypeList_p6_t1, filterList_p6_t1, mergeList,
			poivtList, limitNum_p7_t1, sortMap_p7_t1, sortStr_nomal, selectList, titleList_p6_t1, factory_nomal, keyProdList_p7)
		...
		val p8_t1 = pptInputData("p8_t1_" + cityStr, dataList_p6_t1, valueTypeList_p7_t1, filterList_p7_t1, mergeList,
			poivtList, limitNump8_t1, sortMap_p8_t1, sortStr_other, selectList, titleList_p6_t1, factory_nomal, keyProdList_p8)
